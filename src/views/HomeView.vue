  ...
  data() {
    return {
      ...
      quizData: [
        ...
        // queries: [
        // 'Представьте, что вы находитесь в комнате, которая быстро наполняется водой. Здесь нет ни окон, ни дверей. Как вы выберетесь отсюда?',
        // 'Шли два отца и два сына, нашли три апельсина. Стали делить - всем по одному досталось. Как это могло быть?',
        // 'Что принадлежит вам, но используется всеми остальными больше, чем вами?',
        // 'Что полно дыр, но все еще может удерживать жидкость?',
        // 'Как вы называете женщину, которая все время знает, где находится ее муж?',        
        // ],
        // answers: [
        // 'Перестаньте представлять этот сценарий.',
        // 'На самом деле шло трое человек: дедушка, отец и сын.',
        // 'Ваше имя.',
        // 'Губка.',
        // 'Вдовой.',
        // ],
